  ...
  return <div style={{ padding: 24, overflowY: "auto", flex: 1 }}>
    ...
    {tab === "lubricants" && <div style={S.card}>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse" }}>
        ...
        <tbody><tr><td colSpan={5} style={{ color: "#475569", fontSize: 13, textAlign: "center", padding: "30px 0" }}>No lubricant data yet — add entries to see reports here.</td></tr></tbody>
        </tbody>
      </table>
    </div>}
  </div>;
