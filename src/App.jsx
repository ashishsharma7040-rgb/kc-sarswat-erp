...
import { getFirestore, collection, doc, getDocs, setDoc, addDoc, updateDoc, deleteDoc } from "firebase/firestore";
...
const SettingsView = ({ settings, setSettings, tanks, setTanks, unitConfig, setUnitConfig, onFactoryReset }) => {
  ...
  const handleReset = async () => { setResetErr(""); if (resetPwd.toLowerCase() !== OWNER_CRED.password.toLowerCase()) { setResetErr("Incorrect password."); return; } setResetting(true); await new Promise(r => setTimeout(r, 1200)); onFactoryReset(); setResetting(false); setShowReset(false); setResetPwd(""); setResetStep(1); };
