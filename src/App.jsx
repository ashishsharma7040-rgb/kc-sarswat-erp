...
export default function App() {
  ...
  // Auth state listener — with 8s timeout so it NEVER hangs on loading screen
  useEffect(() => {
    // Safety timeout: if Supabase doesn't respond in 8s, show login page anyway
  ...
  if (authLoading) return (
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", background:"#060d18", fontFamily:"'Sora',system-ui,sans-serif" }}>
      <div style={{ textAlign:"center" }}>
        ...
        <p style={{ color:"#f1f5f9", fontSize:16, fontWeight:700, marginBottom:8 }}>KC Sarswat ERP</p>
        <p style={{ color:"#475569", fontSize:13, marginBottom:20 }}>Connecting to Supabase…</p>
        <div style={{ width:160, height:3, background:"rgba(255,255,255,0.07)", borderRadius:99, overflow:"hidden", margin:"0 auto" }}>
          <div style={{ height:"100%", width:"40%", background:"linear-gradient(90deg,#f59e0b,#d97706)", borderRadius:99, animation:"slide 1.3s ease-in-out infinite" }}/>
        </div>
